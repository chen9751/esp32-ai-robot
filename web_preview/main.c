...
static uint32_t fb[PIXELS]; static int mx,my,ui_w=LAND_W,ui_h=LAND_H; static bool down; static bool web_rotated; static uint32_t last;
EMSCRIPTEN_KEEPALIVE void web_pointer(int x,int y,int pressed){mx=x;my=y;down=pressed!=0;}
EMSCRIPTEN_KEEPALIVE void web_set_rotated(int rotated){web_rotated=rotated!=0;down=false;}
