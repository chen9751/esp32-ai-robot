 ...
 * - Remix Icon filled glyphs, rasterized once as compact A8 masks.
 * - Chinese labels are pre-rendered A8 masks for the fixed home menu.
 *   ui_set_menu_font() remains available for later dynamic CJK pages.
 * - A8 images are recolored white by LVGL, so no RGB icon bitmaps are stored.
 */
