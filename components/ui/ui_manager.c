...
static void home_create(void){s_home=lv_obj_create(NULL);base(s_home);gestures(s_home);lv_obj_t*w=card(s_home,8,10,92,152);label(w,LV_SYMBOL_CLOUDY,8,6,20);label(w,"26 C",8,35,28);label(w,"Cloudy",8,72,14);lv_obj_t*m=label(w,"68% AQI 32",8,108,14);lv_obj_set_style_text_color(m,lv_color_hex(MUTED),0);label(s_home,"SEP 24 THU",118,27,16);label(s_home,"12:53",116,70,28);lv_obj_t*h=label(s_home,"Swipe > Apps",180,142,14);lv_obj_set_style_text_color(h,lv_color_hex(MUTED),0);}
