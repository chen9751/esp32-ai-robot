...
typedef enum {UI_REMOTE_UP,UI_REMOTE_DOWN,UI_REMOTE_LEFT,UI_REMOTE_RIGHT,UI_REMOTE_OK,UI_REMOTE_BACK,UI_REMOTE_HOME,UI_REMOTE_PLAY_PAUSE,UI_REMOTE_VOL_UP,UI_REMOTE_VOL_DOWN,UI_REMOTE_POWER} ui_remote_action_t;
void ui_init(void);
