...
int main(void){
 SDL_Init(SDL_INIT_VIDEO);printf("AI Robot simulator: 640x172 UI v2\n");win=SDL_CreateWindow("ESP32 AI Robot UI v2 - 640x172",SDL_WINDOWPOS_CENTERED,SDL_WINDOWPOS_CENTERED,UI_W*PREVIEW_SCALE,UI_H*PREVIEW_SCALE,0);ren=SDL_CreateRenderer(win,-1,SDL_RENDERER_ACCELERATED);tex=SDL_CreateTexture(ren,SDL_PIXELFORMAT_ARGB8888,SDL_TEXTUREACCESS_STREAMING,UI_W,UI_H);
